...
SQL01 = "SELECT * FROM UBZ002 WHERE UBZ002004 <> '000' AND UBZ002001+UBZ002002+UBZ002003 = '"+PK01+"'";
		...
		<div class="container">
			...
			<div class="card shadow">
				...
				<div class="container mb-3">
					<div class="row">
					  <div class="col">
						<label for="formControlInput" class="form-label">關鍵字</label>
						<div class="input-group">
						  <input name="KW01" type="text" id="KW01" value="<%=KW01%>" class="form-control" placeholder="請輸入代碼名稱">
						  <input type="button" class="btn btn-green border-dark" value="查 詢" onClick="javascript:SF01('UBC980200','jsp','_self','<%=PK01%>','');">
						  <input type="button" class="btn btn-green border-dark" value="回代碼類別" onClick="javascript:SF01('UBC980100','jsp','_self','','');">
						</div>
					  </div>
					</div>
					...
					<div class="form-group row mb-3">
						<div class="col-12" align="right">
						  <button type="button" class="btn btn-light border-secondary" onClick="SF01('UBC980201','jsp','_self','<%=PK01%>','UBC980201.jsp')"><i class="fa fa-plus pr-2"></i>新增代碼</button>
						</div>
					</div>
					<div>
					<table class="table table-striped">
						<thead class="bg-deepgreen text-light" align="center">
							<tr class="">
								...
								<td align="center" nowrap ><strong>識別碼</strong></td>
								<td align="center" nowrap ><strong>顯示狀態</strong></td>
								<td align="center" nowrap ><strong>修改</strong></td>
							</tr>
						</thead>
					...
					%>
					  <tr class="R_C1">
						...
						<td width="1%" align="center" valign="top" nowrap>
							<button type="button" class="btn btn-light border-secondary" onClick="SF01('UBC980202','jsp','_self','<%=RS01[A].get("UBZ002001").toString()+RS01[A].get("UBZ002002").toString()+RS01[A].get("UBZ002003").toString()+RS01[A].get("UBZ002004").toString()%>','UBC980202.jsp')"><i class="fa fa-edit pr-2"></i></button>
						</td>
					  </tr>
					  <%
					}
...
//alert("AA");
form1.target="_self";
form1.action="<%=request.getRequestURI()%>";
form1.PNO01.value=a;
form1.submit();
}
