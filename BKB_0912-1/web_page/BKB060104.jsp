...
String SENDURL = "BKB060100";
String BKA008001 = SQLIJ(request.getParameter("BKA008001"));
String MSG01="";
try{
	PreparedStatement preSMT01 = null;
	SQL01 = "DELETE FROM BKA008 WHERE BKA008001 = ? ";
	preSMT01 =  CONN01.prepareStatement(SQL01);
	preSMT01.setString(1, BKA008001);
	preSMT01.executeUpdate();
	preSMT01.close();
	String URA004_MSG = URA004_Log(USERID,SC01,BKA008001,"","庫存場次維護",URA004006);
	MSG01="庫存刪除成功";
}catch(Exception e){
	e.printStackTrace();
	MSG01=e.toString()+"<br>庫存刪除錯誤，請洽系統管理人員";
}
%>
<!DOCTYPE html>
<html lang="zh">
...
<% if (MSG01.equals("庫存刪除成功") && SENDURL!=null && SENDURL!=""){ %>
Swal.fire({
  icon: 'success',
  title: '系統訊息',
  text: '<%=MSG01%>',
