...
%>
<%
String URA001002 = SQLIJ(request.getParameter("URA001002"));  //姓名
String TOrder = SQLIJ(request.getParameter("TOrder"));  //排序用
if(TOrder.equals(""))TOrder=" URA001001 ";
...
if(SQL01.equals("")){
    SQL01 = "SELECT * FROM URA001 LEFT JOIN CRA006 ON URA001001 = CRA006001 WHERE URA001003 = '承辦人' ORDER BY "+TOrder;  //無查詢條件，僅列承辦人
}else{
    SQL01 = "SELECT * FROM URA001 LEFT JOIN CRA006 ON URA001001 = CRA006001 WHERE URA001003 = '承辦人'  " + SQL01 + " ORDER BY "+TOrder;
}
//out.print(SQL01);
//if(true)return;   //終止程式
...
<input name="CRA006001" type="hidden" id="CRA006001" value="">
<div class="container">
	</br></br>
			...
			<div class="col-sm">
				...
				<div class="input-group">
					...
					<div class="input-group-append">
						<button type="button" class="btn btn-info" onclick="SF02('THA300200','_self')"><i class="fa fa-search pr-2"></i>查詢</button>
					</div>
				</div>
			</div>
		  </div>
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr align="center">
						...
						<td><%=RS01[A].get("CRA006002").toString()%></td>
						<td><button type="button" class="btn btn-sm btn-success" onclick="SF01('THA300201','_self','<%=RS01[A].get("URA001001").toString()%>')"><i class="fa fa-pencil"></i></button></td>
					</tr>
					<%}%>
				</tbody>
			</table>
