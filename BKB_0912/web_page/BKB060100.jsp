...
if(TOrder.equals(""))TOrder=" BKA008904 DESC";
if(!BKA008002.equals("")){
  SQL01 += " AND BKA008002 = '" + BKA008002 + "'";
}
if(!BKA008003.equals("")){
  SQL01 += " AND BKA008003 = '" + BKA008003 + "'";
}
if(!BKA008004.equals("")){
  SQL01 += " AND BKA008004 LIKE '%" + BKA008003 + "%'";
}
if(SQL01.equals("")){
    SQL01 = "SELECT * FROM BKA008 WHERE BKA008001 <> '' ORDER BY "+TOrder;  //無查詢條件全列
}else{
    SQL01 = "SELECT * FROM BKA008 WHERE BKA008001 <> '' " + SQL01 + " ORDER BY "+TOrder;
}
// out.print(SQL01);
					...
					<div class="card-body">
						<div class="row mt-2">
							<div class="col-xl">
								...
								<select class="form-select" aria-label="Default select" id="BKA008002" name="BKA008002" onChange="getCode('getSelect',this.value,'','form1.BKA008003','UBZ002')">
