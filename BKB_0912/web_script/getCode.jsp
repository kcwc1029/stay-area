...
if(selkind.equals("getSelect")){
	SQL01="SELECT UBZ002008 AS T1,UBZ002008 AS T2 FROM UBZ002 WHERE UBZ002011 = '"+ selvalue1 +"' AND UBZ002010 <> '0'  GROUP BY UBZ002008,UBZ002010 ORDER BY UBZ002010";
}
