...
%>
<%
SQL01 = "SELECT * FROM UBZ002 WHERE UBZ002001+UBZ002002+UBZ002003 = '" + PK01 + "'";
RS01 = TAB01.buildMaps(SQL01);

String CT01 = "";
for(int A=0; A<RS01.length; A++){
	if(RS01[A].get("UBZ002004").toString().equals("000")){
		CT01 = RS01[A].get("UBZ002011").toString();
	}
}
%>
<!doctype html>
